import {AdditiveBlending, BufferAttribute, BufferGeometry, Uniform, Points as ThreePoints, ShaderMaterial} from "three";
...
class Points extends ThreePoints<BufferGeometry, ShaderMaterial> {
    ...
    public setUniforms(name: string, value: Uniform) {
